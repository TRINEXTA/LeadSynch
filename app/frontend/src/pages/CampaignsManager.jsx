            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                <p className="text-xs text-gray-600 mt-1">
                  {users.length === 0 ? '?? Aucun utilisateur chargé' : `? ${users.length} utilisateurs disponibles`}
                </p>
              </div>
              ...
              {users.length === 0 ? (
                <div className="text-center py-8 bg-yellow-50 border-2 border-yellow-200 rounded-xl">
                  ...
                  <p className="font-bold text-gray-900">Aucun utilisateur trouvé</p>
                  <p className="text-sm text-gray-600 mt-2">
                    Vérifiez que des utilisateurs existent dans le système
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-2 gap-4">
